...
#pragma config(Motor,  port1,           leftF,         tmotorNone, openLoop)
#pragma config(Motor,  port2,           launcher,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           rightF,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           rightM,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           rightR,        tmotorVex393_MC29, openLoop)
